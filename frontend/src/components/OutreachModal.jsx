        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-100">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-indigo-50/50">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900">GenAI Outreach Studio</h2>
                        <p className="text-xs text-indigo-600 font-medium uppercase tracking-wider mt-0.5">Personalized retention draft</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-8">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-12">
                            ...
                            <p className="mt-4 text-gray-600 animate-pulse">Groq is drafting your message...</p>
                        </div>
                    ) : outreachData ? (
                        <div className="space-y-6">
                            <div>
                                <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Subject Line</label>
                                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 text-gray-800 font-medium">
                            ...
                            <div>
                                ...
                                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-gray-700 leading-relaxed min-h-[200px] whitespace-pre-wrap">
                        ...
                        <p className="text-center text-gray-500">No content generated.</p>
                    )}
                </div>
                ...
                <div className="bg-gray-50 p-6 flex justify-end space-x-3">
                    <button
                        onClick={onClose}
                        className="px-6 py-2.5 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-200 transition-colors"
                    >
                        Dismiss
                    </button>
                    <button
