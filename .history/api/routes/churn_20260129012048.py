...
async def get_analytics():
    ...
    try:
        ...
        # Calculate predictions for all customers (sample for performance)
        ...
        for customer_id, row in sample_df.iterrows():
            ...
            try:
                ...
                risk_level = prediction.get("churn_risk", "Low")
        ...
        scale_factor = len(CUSTOMER_DF) / sample_size
        scaled_risk_counts = {
        ...
        avg_probability = total_probability / len(predictions) if predictions else 0
        
        # Calculate high risk customers for "at-risk" metric
        high_risk_count = scaled_risk_counts["High"]
        
        return {
            "risk_distribution": scaled_risk_counts,
