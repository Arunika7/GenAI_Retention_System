...
const Customers = () => {
    ...
    const customers = [
        ...
        { id: 'CUST-006', name: 'Fiona Martinez', category: 'Snacks & Beverages', spend: 2150, risk: 'Low', location: 'Miami', discount_sensitivity: 'Medium' },
        { id: 'CUST-007', name: 'George Wilson', category: 'Household Essentials', spend: 3800, risk: 'Medium', location: 'Chicago', discount_sensitivity: 'High' },
        { id: 'CUST-008', name: 'Hannah Lee', category: 'Personal Care', spend: 1950, risk: 'Low', location: 'Seattle', discount_sensitivity: 'Low' },
        { id: 'CUST-009', name: 'Ian Cooper', category: 'Electronics', spend: 580, risk: 'High', location: 'Boston', discount_sensitivity: 'High' },
        { id: 'CUST-010', name: 'Julia Anderson', category: 'Grocery', spend: 5200, risk: 'Low', location: 'Austin', discount_sensitivity: 'Medium' },
        { id: 'CUST-011', name: 'Kevin Park', category: 'Snacks & Beverages', spend: 720, risk: 'Medium', location: 'Portland', discount_sensitivity: 'Low' },
        { id: 'CUST-012', name: 'Laura Thompson', category: 'Beauty', spend: 2850, risk: 'Low', location: 'Denver', discount_sensitivity: 'High' },
        { id: 'CUST-013', name: 'Michael Davis', category: 'Household Essentials', spend: 340, risk: 'High', location: 'Miami', discount_sensitivity: 'Medium' },
        { id: 'CUST-014', name: 'Nina Patel', category: 'Personal Care', spend: 4100, risk: 'Low', location: 'Chicago', discount_sensitivity: 'Low' },
        { id: 'CUST-015', name: 'Oscar Rodriguez', category: 'Electronics', spend: 1680, risk: 'Medium', location: 'Boston', discount_sensitivity: 'High' },
    ];
