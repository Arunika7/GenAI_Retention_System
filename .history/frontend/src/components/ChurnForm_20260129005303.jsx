    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 h-full">
            ...
            <div className="mb-6 pb-6 border-b border-gray-200">
                <label className="block text-sm font-medium text-gray-700 mb-3">Quick Simulation Presets</label>
                ...
                <p className="mt-2 text-xs text-gray-500">Click a preset to auto-fill the form with sample data, then customize as needed</p>
            </div>
